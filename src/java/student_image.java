...
public class student_image extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // String faculty_user = (String)
            // request.getSession().getAttribute("faculty_user");
            ...
            try {
                ...
                if (!isMultipart) {
                    ...
                    try {
                        if (A.equals("SS")) {
                            Connection con = DBConnection.getConnection("student_login");
                            Statement st = con.createStatement();
                            ////                            out.println(itemName);
                            st.executeUpdate("update login set imagepath='" + itemName + "' where username='"
                                    + student_username + "'");
